...
export function compareScreens(type, a, z) {
  ...
  let { min: aMin, max: a***REMOVED*** } = aScreen.values[0]
  let { min: zMin, max: z***REMOVED*** } = zScreen.values[0]

  // Negating screens flip their behavior. Basically `not min-width` is `max-width`
  if (a.not) [aMin, a***REMOVED***] = [a***REMOVED***, aMin]
  if (z.not) [zMin, z***REMOVED***] = [z***REMOVED***, zMin]

  aMin = aMin === undefined ? aMin : parseFloat(aMin)
  a***REMOVED*** = a***REMOVED*** === undefined ? a***REMOVED*** : parseFloat(a***REMOVED***)
  zMin = zMin === undefined ? zMin : parseFloat(zMin)
  z***REMOVED*** = z***REMOVED*** === undefined ? z***REMOVED*** : parseFloat(z***REMOVED***)

  let [aValue, zValue] = type === 'min' ? [aMin, zMin] : [z***REMOVED***, a***REMOVED***]
